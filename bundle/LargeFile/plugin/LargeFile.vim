...
"  call Dfunc("s:Unlarge()")
  ...
  if exists("b:bhkeep") |let &l:bh  = b:bhkeep |endif
  if exists("b:fdmkeep")|let &l:fdm = b:fdmkeep|endif
  if exists("b:swfkeep")|let &l:swf = b:swfkeep|endif
  syn on
  doau FileType
"  call Dret("s:Unlarge")
endfun
